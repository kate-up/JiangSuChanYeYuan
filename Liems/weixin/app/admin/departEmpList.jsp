...
<%
	...
	String depNo=Charset.nullTo0(request.getParameter("depNo"));
	String depName=WebTools.getDepName(Long.parseLong(depNo));
%>
<!DOCTYPE html>
<html lang="zxx">
<head>
	...
	<link rel="stylesheet" href="aweto/pages/ucenter/style.css">
	<script type="text/javascript"> 
		...
		function loadData(){
			aweto.ajax(basePath+namespace+"/tableList.ajax",{pageNo:pageNo,pageSize:5,comNo:comNo,depNo:depNo,searchCondition:condition},true,function(r){
				pageNo=r.pageNo+1;
...
<body>
			...
			<div class="row">
				<div class="col s9">
					<div class="content-left">
						<a href="javascript:weixin.toDepartList()"><h1><i class="fa fa-chevron-left"></i><span></span>部门员工管理</h1></a>
					</div>
				</div>
				<div class="col s3" >
	...
	<div class="list segments-page">
	    ...
	    <div class="pages-title">
					<h3><%=depName %>（<span id="num"></span>人）</h3>
					<div class="line"></div>
		</div>
