        ...
        <form class="form-horizontal" id="detailForm" novalidate="novalidate">
            <div class="row">
                <div class="form-group col-xs-12 col-sm-12">
                    <label class="col-sm-3 col-xs-3 control-label is-required">会议名称</label>
                    <div class="col-sm-9 col-xs-9">
                        <input id="visitorNam" name="visitorNam" class="form-control" >
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-12">
                    <label class="col-sm-3 col-xs-3 control-label is-required">会议主题</label>
                    <div class="col-sm-9 col-xs-9">
                        <input id="visitorNam0" name="visitorNam0" class="form-control" >
                    </div>
                </div>
                ...
                <div class="form-group col-xs-12 col-sm-12">
                    ...
                    <div class="col-sm-8 col-xs-9">
                        <input id="visitorNam1" name="visitorNam1" class="form-control" >
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-12">
                    <label class="col-sm-3 col-xs-3 control-label">申请人</label>
                    <div class="col-sm-8 col-xs-9">
                        <input id="visitorNam2" name="visitorNam2" class="form-control" >
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-12">
                    <label class="col-sm-3 col-xs-3 control-label is-required">召集人</label>
                    <div class="col-sm-9 col-xs-9">
                        <input id="visitorNam3" name="visitorNam3" class="form-control" >
                    </div>
                </div>
                <div class="form-group col-xs-12 col-sm-12">
                    <label class="col-sm-3 col-xs-3 control-label is-required">主持人</label>
                    <div class="col-sm-9 col-xs-9">
                        <input id="visitorNam4" name="visitorNam4" class="form-control" >
                    </div>
                </div>
                <div class="layout_bet">
                    <div>允许会员上传文档</div>
