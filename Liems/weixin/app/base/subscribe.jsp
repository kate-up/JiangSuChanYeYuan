...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String biz	=Charset.nullToEmpty(request.getParameter("biz"));
	String url="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz="+biz+"&scene=110#wechat_redirect";
	String msgInfo="绑定失败！";
  ...
  <body ontouchstart>
    ...
    <div class="weui-msg">
      ...
      <div class="weui-msg__text-area">
        <h2 class="weui-msg__title">请扫二维码<br/>或点击如下链接关注公众号</h2>
        
        <a href="<%=url %>" style="">关注公众号</a>
      </div>
